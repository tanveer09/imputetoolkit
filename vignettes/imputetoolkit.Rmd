...
plot_metrics(res, metric = "ALL")             # Combined panel
```

Example output:

![Comparison of Imputation Methods across All Metrics](example_plot_all.png)
...
-   Top panel shows overlap for all numeric variables.
-   Lower panel zooms into one column (e.g. `age`) to inspect shape preservation.

![True vs Imputed Density Comparison](example_density_all.png)
